...
; by default PrivateBin will guess the visitor's language based on the browser's
; settings. Optionally you can enable the language selection menu, which uses
; a session cookie to store the choice until the browser is closed.
languageselection = false

; set the language your install defaults to, defaults to English
; if this is set and language selection is disabled, this will be the only language
; languagedefault = "en"

; (optional) URL shortener address to offer after a new paste is created
; it is suggested to only use this with self-hosted shorteners as this will leak
; the paste's encryption key
...
; Can be set to one of these values: none / vizhash / identicon (default).
; icon = none
...
; By default, this disallows loading images from third-party servers, e.g., when they are embedded in pastes. If you wish to allow that, you can adjust the policy here. See https://github.com/PrivateBin/PrivateBin/wiki/FAQ#why-does-not-it-load-embedded-images for details.
...
; set the HTTP header containing the visitor's IP address, i.e., X_FORWARDED_FOR
